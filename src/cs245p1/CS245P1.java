 ...
 * Also maintains a single static game state for each of the three games, so that game values (such as score)
...
public class CS245P1 {
    ...
    public CS245P1() {
        ...
        //add the action listener to the relevant buttons
        ...
        root.getActionMap().put("F1 Pressed", new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                popUpCreditsPanel.setLocationRelativeTo(mainFrame);
                popUpCreditsPanel.pack();
                popUpCreditsPanel.setVisible(true);
            }
        }
        );
